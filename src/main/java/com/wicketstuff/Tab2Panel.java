...
public class Tab2Panel extends Panel {
    public Tab2Panel() {
        ...
        Select2Choice<DictionaryBase> choiceWorkingOnTab = new Select2Choice<DictionaryBase>("choiceWorkingOnTab", null, new DictionaryBaseProvider(choiceList,"project"));
        choiceWorkingOnTab.getSettings().setMinimumInputLength(0);
        choiceWorkingOnTab.setRequired(false);
        choiceWorkingOnTab.getSettings().setWidth("200px");
        add(choiceWorkingOnTab);
    }
